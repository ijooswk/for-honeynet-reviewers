...
public class Process {
     ...
     */
    public static final int myPid() {return 1;}

    /**
     * Returns the identifier of the calling thread, which be used with
     * {@link #setThreadPriority(int, int)}.
     */
    public static final int myTid() {return 1;}
    ...
    /** @hide */
    public static final int[] getPids(String path, int[] lastArray) {return lastArray;}
    ...
    public static final boolean readProcFile(String file, int[] format,
            String[] outStrings, long[] outLongs, float[] outFloats) {return false;}
    
    /** @hide */
    public static final boolean parseProcLine(byte[] buffer, int startIndex, 
            int endIndex, int[] format, String[] outStrings, long[] outLongs, float[] outFloats) {return false;}
