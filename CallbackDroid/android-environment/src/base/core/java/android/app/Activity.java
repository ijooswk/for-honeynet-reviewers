...
public class Activity extends ContextThemeWrapper
    ...
    //#wujl
    //@wujl added
    private WindowManager mWindowManager = new MockWindowManagerImpl();
    //#wujl
    ...
    private final Handler mHandler = null; //new Handler();

	//@baigd
	public Resources res; 
	public XmlResourceParser xrp;
	public boolean apf_gen = false;
	public ApfViewGenerator viewGen;
	public Hashtable<String, View> idViewTable = null;
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
		//@baigd
		// for DroidBench/AndroidSpecific_DirectLeak1
		//original: 
		/*
    ...
    public View findViewById(int id) {
		...
		String idStr = "0x" + Integer.toHexString(id);
		View value = (View)idViewTable.get(idStr);
		return value;
		//#baigd
    }
    ...
    public void setContentView(int layoutResID) {
		...
		/*xrp = res.getXml(layoutResID);
		if(xrp == null)
			System.out.println("xrp is null");
		else
			System.out.println("xrp is not null");*/
		if(apf_gen == false)
			return;
		viewGen.onSetContentView(layoutResID);
		//#baigd
    }
    ...
    public void startActivityForResult(Intent intent, int requestCode) {
        //@yqq
        //System.out.println("^src/base/core/java/android/app/Activity.java::startActivityForResult()");
        //System.out.println(mParent == null ? "mParent null" : "mParent not null");
        //System.out.println("$src/base/core/java/android/app/Activity.java::startActivityForResult()");
        //@original
        //if (mParent == null) {
        //    //@yqq
        ...
        //            intent, requestCode);
        //    //#original
        //    //Instrumentation.ActivityResult ar = null;
        //    //mMainThread.getApplicationThread();
        //    //#yqq
        //    //@yqq
        //    //System.out.println(ar == null ? "ar null" : "ar not null");
        //    //#yqq
        //    if (ar != null) {
	...
	*/
    ...
    //@yqq
    //for Driver to mApplication
    public void setmApplication(Application app)
    {
