...
public abstract class SQLiteOpenHelper {
    ...
    public synchronized SQLiteDatabase getWritableDatabase() {
        ...
        try {
            //@yqq
            //debug
            //System.out.println("inside getWritableDatabase try");
            //#yqq
            mIsInitializing = true;
            if (useMock) {
                //@yqq
                //debug
                //System.out.println("getting a mock databse");
                //#yqq
                Log.i(TAG, "new MockSQLiteDatabase()");
                db = new mymock.MockSQLiteDatabase();
            } else if (mName == null) {
            ...
            if (version != mNewVersion) {
                ...
                try {
                    ...
                    if (version == 0) {
                        //@yqq
                        //debug
                        //System.out.println("inside if try if");
                        //#yqq
                        onCreate(db);
                    } else {
                        if (version > mNewVersion) {
            ...
            //@yqq
            //debug
            //System.out.println("about to return db");
            //#yqq
            return db;
        } finally {
    ...
    public synchronized SQLiteDatabase getReadableDatabase() {
        //@yqq
        //debug
        //System.out.println("getting readable database");
        //#yqq
        ...
        try {
            //@yqq
            //debug
            //System.out.println("about to execute getWritableDatabase");
            //#yqq
