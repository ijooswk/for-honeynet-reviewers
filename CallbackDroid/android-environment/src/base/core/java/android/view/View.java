...
public class View implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    */
    ...
    public View(Context context) {
        ...
        //++sInstanceCount;
		//@baigd
		// comment by baigd because these two functions call the native method
    ...
    public View(Context context, AttributeSet attrs, int defStyle) {
        this(context);
		//@baigd
		//comment by baigd because it calls native method
    ...
    */
    ...
    public void setOnClickListener(OnClickListener l) {
        ...
        mOnClickListener = l;
		//@baigd
		//System.out.println("onclicklistener is called");
    ...
    public boolean performClick() {
		//@baigd
		/* comment by baigd because it calls to a native method */
       /* sendAccessibilityEvent(AccessibilityEvent.TYPE_VIEW_CLICKED);
		...
		//	System.out.println("onlick is null");
		return false;
		//#baigd
    }
