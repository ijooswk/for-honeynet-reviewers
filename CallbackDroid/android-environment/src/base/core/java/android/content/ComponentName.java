...
public final class ComponentName implements Parcelable, Cloneable, Comparable<ComponentName> {
    ...
    public String getShortClassName() {
        ...
        //System.out.println("/src/base/core/java/android/content/ComponentName.java::getShortClassName()");
    ...
    public String flattenToShortString() {
        //@yqq
        //System.out.println("start logging");
        //System.out.println("/src/base/core/java/android/content/ComponentName.java::flattenToShortString()");
        //System.out.println("end logging");
        if (mPackage == null && mClass != null)
        {
            return "mPackage == null " + "mClass = " + mClass;
            //return "mPackage null" + "/" + "can not invoke getShortClassName()";
        }
        //#yqq
