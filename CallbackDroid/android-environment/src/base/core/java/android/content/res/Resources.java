...
public class Resources {
    ...
    //@yqq
    // pass the current activity to resource in order to visity activity's member
    ...
    public String getString(int id) throws NotFoundException {
        ...
        */
        ...
        //{
        //    Activity curAct = (Activity)mContext;
        //    if (curAct.findViewById(id) instanceof Button)
        //    {
        //        Button curBut = (Button)(curAct.findViewById(id));
        //        return curBut.getText().toString();
        //    }
        //}
