...
//@yqq
import mymock.MockDummyBitmap;
//#yqq

//@yqq
//modified for extent this class to MockDummyBitmap
//@original
...
//#yqq
    ...
    */
    //@yqq
    //to easy access to super class's contructor for MockDummyBitmap
    //@original
    //private Bitmap(int nativeBitmap, boolean isMutable, byte[] ninePatchChunk,
    //#original
    public Bitmap(int nativeBitmap, boolean isMutable, byte[] ninePatchChunk,
            int density) {
    //#yqq
        if (nativeBitmap == 0) {
    ...
    public static Bitmap createBitmap(int width, int height, Config config) {
        ...
        //return bm;
        //@yqq
        //for some app which needs a reference
        //@original
		//return null;
        return new MockDummyBitmap();
        //#original
        //#yqq
		//#baigd
    }
