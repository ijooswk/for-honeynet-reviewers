...
import com.gedeng.ui.WelcomeActivity;

/**
 * Created by yuanchun on 7/16/14.
...
public class QxMessageReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            ...
            if (message != null && !"".equals(message) && !"{}".equals(message)) {
                QxPushManager.notifyMessageReceived(message);
            }
            ...
            Log.e(TAG, "" + intent.getAction() +" connected state change to "+connected);
        } else {
