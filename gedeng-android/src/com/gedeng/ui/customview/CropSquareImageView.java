...
public class CropSquareImageView extends ImageView {
	...
	public void init() {
		...
		leftAreaPaint.setAlpha(CropSquareImageView.LEFT_AREA_ALPHA);
	}
	...
	private boolean isOutOfArea(int x, int y) {
		switch (recFlag) {
		case CropSquareImageView.PRESS_T:
			this.pressT(x - mx, y - my);
			break;
		case CropSquareImageView.PRESS_L:
			this.pressL(x - mx, y - my);
			break;
		case CropSquareImageView.PRESS_B:
			this.pressB(x - mx, y - my);
			break;
		case CropSquareImageView.PRESS_R:
	...
	public boolean findPresseddst(int x, int y) {
		...
		if (this.isInRect(x, y, recT)) {
			recFlag = CropSquareImageView.PRESS_T;
			returnFlag = true;
		} else if (this.isInRect(x, y, recL)) {
			recFlag = CropSquareImageView.PRESS_L;
			returnFlag = true;
		} else if (this.isInRect(x, y, recB)) {
			recFlag = CropSquareImageView.PRESS_B;
			returnFlag = true;
		} else if (this.isInRect(x, y, recR)) {
			recFlag = CropSquareImageView.PRESS_R;
			returnFlag = true;
		}
