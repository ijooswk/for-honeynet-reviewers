...
public class MessageCommentedListAdapter extends BaseAdapter {
	private Context context;
	private ArrayList<QxMessage> messages;

	public MessageCommentedListAdapter(Context context, ArrayList<QxMessage> messages) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.comment_message_list_item, null);
        }
                ...
                if (uiUserBasicInfo != null) {
                    portraitImageView.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View v) {
                            ...
                            intent.putExtra(Constants.EXTRA_NAME_POST_BASIC_INFO, uiUserBasicInfo);
        ...
        // render comment-related views
        // TODO: need getCommentByID API
